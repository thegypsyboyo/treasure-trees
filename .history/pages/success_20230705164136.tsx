...
const SuccessPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Retrieve the customer data from the backend using the session ID
    const fetchCustomerData = async () => {
      try {
        ...
        const data: { customer: CustomerData } = await response.json();
        setName(data.customer.firstName + ' ' + data.customer.lastName);
