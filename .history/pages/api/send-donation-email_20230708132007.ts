...
const sendDonationEmail = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    ...
    const mailOptions = {
      ...
      text: `Dear ${firstName} ${lastName},\n\nWe wanted to take a moment to express our heartfelt gratitude for your generous donation. Your support means the world to us and has a significant impact on [Treasure Trees]. Thanks to your contribution, we can continue our mission of planting more trees.\n\nYour generosity is truly inspiring, and we are incredibly grateful for your commitment to making a difference. With your help, we can [provide assistance/research/find solutions] to those in need and create a positive change in our community.\n\nOnce again, thank you for your kindness and belief in our cause. We are honored to have you as a donor and look forward to keeping you updated on the progress we achieve together.\n\nWishing you all the best,\n\n[Bob Van Der BIjl]\n[TREASURE TREES]`,
      html: `<p>Dear ${firstName} ${lastName},</p><p>We wanted to take a moment to express our heartfelt gratitude for your generous donation. Your support means the world to us and has a significant impact on [cause/organization]. Thanks to your contribution, we can continue our mission of [describe the mission or work of the organization].</p><p>Your generosity is truly inspiring, and we are incredibly grateful for your commitment to making a difference. With your help, we can [provide assistance/research/find solutions] to those in need and create a positive change in our community.</p><p>Once again, thank you for your kindness and belief in our cause. We are honored to have you as a donor and look forward to keeping you updated on the progress we achieve together.</p><p>Wishing you all the best,</p><p>[Your Name]</p><p>[Your Organization]</p>`,
    };
