                ...
                <div className="row">
                    ...
                    <div className="col-xl-7">
                        <div className="team-details-content">
                            ...
                            <p className="mb-20">Most gardens consist of a mix of natural and constructed elements, although even very natural gardens are always an inherently artificial creation. Natural elements present in a garden principally.</p>
