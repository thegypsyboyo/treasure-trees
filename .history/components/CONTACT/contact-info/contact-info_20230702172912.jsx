        ...
        <div className="contact-info__container">
            <div className="contact-wrapper__container">
                ...
                <div className="contact-title">
                    ...
                    {sliderData[0]?.description} {/* Accessing the 'description' property */}
                    </span>
                    <h2 className="contact-main__title mb-[35px]">
                    {sliderData[0]?.title} {/* Accessing the 'title' property */}
                    </h2>
                </div>
                ...
                {sliderData[0]?.image ? (
                <div className="contact-wrapper__img">
                    <Image src={urlFor(sliderData[0]?.image).url()} width={600} height={600} alt="contact-img" />
                </div>
                ) : (
