...
const data =  [
    {
        title: "our mission",
        desc: "Gardening is the practice of growing and cultivating plants as part of horticulture. In gardens, ornamental plants are often grown.",
        img_url: mission_icon,
        bg_imgurl: about_thumb,
    },
    {
        title: "our vision",
        desc: "Gardening is the practice of growing and cultivating plants as part of horticulture. In gardens, ornamental plants are often grown.",
        ...
        <div className='mission-cotainer__content'>
            {data.map((item, index) =>(
                    ...
                    <div className="img-content">
                        <div className="img">
                        <Image src={`${item?.img_url}`} width={100} height={100}/>
                        </div>
