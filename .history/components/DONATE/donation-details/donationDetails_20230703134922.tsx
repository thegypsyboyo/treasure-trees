                                ...
                                <div className="single-donation-content">
                                    ...
                                    <div className="progress-wrapper">
                                        <div className="feature-progress">
                                            <div className="progress-bar" style={{width: causesData.estimatePercentage + "%"}}/>
                                        </div>
                                    </div>
                                    {/* <div className="single-cause-meta">
                                        {singleCause.map((item, index) =>(

                                            <div className="single_meta feature-meta" key={index}>
                                                <span className='meta-text'>
                                                    <i>{item.icon}</i>
                                                    {item.title}
                                                </span>
                                                <span className='meta-price single-price'>
                                                    ${item.amount}
                                                </span>
                                            </div>
