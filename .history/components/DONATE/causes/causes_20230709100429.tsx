              ...
              <div className='row'>
                <div className="col-lg-7">
                  <div className="section-title">
                    ...
                    <div className="sub-title">-- causes --</div>
                    <div className="title">causes</div>
                  </div>
                </div>
              </div>
                                  ...
                                  <div className="diation-details">
                                    <div className="progressbar-container">
                                      ...
                                      <div className="progressbar-nav">
                                          <div className="inner" style={{width: item.estimatePercentage + "%" ,backgroundColor:"#86b85e"}}></div>
                                      </div>  
                                      <div className="give-goal">
                                        <div className="raised">
                                          <span>${item.amountDonated}  </span>
                                          of 
                                          <span> ${item.amountTargeted} raised</span>
                                        </div>
