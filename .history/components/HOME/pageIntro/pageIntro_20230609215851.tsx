...
const pageIntro = () => {
  ...
  if (!sliderData) {
    return null; // or any fallback UI when sliderData is not available
  }
  console.log("sliderData.sinceFrom", sliderData[0]?.sinceFrom);
  console.log("sliderData.sinceFrom", sliderData[0]?.sinceFrom);
  ...
  return (
    <section className='page-intro' >
      ...
      >
        {dataSlider.sliders?.map((item, index) =>(
                    ...
                    <div className="col-lg-8 col-md-12">
                      <div className="banner-content">
                        <div className="banner-meta-text">
                            <span>[ {dataSlider.sinceFrom} ]</span>
                        </div>
                        ...
                        <div className="banner-btn">
                          <div className="banner-meta-review">
                            ...
                            <div className="meta-review-text">
                              <span>{dataSlider.activeReviews}</span>
                              Active reviews
                            </div>
                          </div>
