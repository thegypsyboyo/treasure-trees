                    ...
                    <div className="col-lg-3">
                        <div className="footer-widget footer1-widget footer1-widget2">
                            ...
                            <ul>
                                    ...
                                    <li><Link href="/portfolio">Meet the Trees</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-lg-3">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-4">
                            <div className="footer-logo">
                                {item.logo ? (
                                    <Link href="/"><img src={urlFor(item.logo).url()} alt="logo"/></Link>
                                    ): (
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="copyright-text">
                                Copyright &amp; Design By 
                                {item.socials.map((soc) => (
                                    <a href={`${soc.url}`} rel="noreferrer noopener" target="_blank"> {soc.platform === "instagram"  && "@treasuretreesteam" }</a> 
                                ))}
                                - 2023
                            </div>
                        </div>
