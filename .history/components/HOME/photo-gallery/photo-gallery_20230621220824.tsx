...
const PhotoGallery:React.FC = () => {
    const [sliderData, setSLiderData] = useState<PortfolioItem[] | null>(null)
    ...
    const [filteredPortfolioItems, setFilteredPortfolioItems] = useState(data);
    ...
    }, [activeFilter, portfolioItems, data])
