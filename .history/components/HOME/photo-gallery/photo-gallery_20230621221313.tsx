...
const PhotoGallery:React.FC = () => {
    const [sliderData, setSLiderData] = useState<PortfolioItem[]>()
    ...
    const [portfolioItems, setPortfolioItems] = useState(sliderData);
    const [filteredPortfolioItems, setFilteredPortfolioItems] = useState(sliderData);
    ...
    useEffect (() => {
        setPortfolioItems(sliderData);
        setFilteredPortfolioItems(sliderData);
    }, [sliderData])
    ...
    }, [activeFilter, portfolioItems, sliderData])
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="section-title">
                            ...
                            <h2 className="section-main-title mb-45">MEET OUR TREES</h2>
                        </div>
                    </div>
                    <div className="col-lg-6">
                                                        ...
                                                        <div className="portfolio-content">
                                                            <div className="portfolio-inner">
                                                                ...
                                                                <h4 className="portfolio-title">
                                                                    <a href="/portfolio-details/2">{item.description}</a>
                                                                </h4>
                                                            </div>
