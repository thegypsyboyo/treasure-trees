...
import { FaCalendar, FaFacebookF, FaInstagram, FaLinkedinIn, FaSearch, FaTwitch, FaTwitter, FaYoutube } from "react-icons/fa"
...
const BlogList = ({posts }: Props) => {
    ...
    //     setFilteredPosts(results);
    // };
    console.log("POST DESCRIPTION", posts.map((item) => item.description))
  return (
    ...
    //     </div>
    // </section>
    <div>Posts: {posts.map((item) => item._createdAt)}</div>
  )
}
