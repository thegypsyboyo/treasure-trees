...
const some = () => {
    ...
    const [sliderData, setSLiderData] = useState<QuestionAnswers[] | null>(null)
    ...
    console.log("QUESTIONS : ", sliderData?.map((item) => item.question))

    

    console.log("ALL DATA : ", QnAData)
            ...
            <div className="row">
                <div className="col-lg-6">
                    ...
                    {QnAData ? (
                        ...
                        <div className='flex items-center justify-center'>Loading questions...</div>
                    )}
                </div>
            </div>
        </div>
