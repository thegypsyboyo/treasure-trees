...
const PortfolioDetailsContent = ({portfolio,allPortfolio}: Props) => {
  ...
  return (
    ...
    {portfolio.singlePortfolioDatas ? (
        ...
        <Link href={"/portfolio"}  className="bg-[#339638] text-white cursor-pointer pointer flex items-center w-[30px] ml-auto mr-auto  justify-center mt-[10px] mb-[50px] uppercase">go back</Link>
        </>
    )}
    </>
  )
