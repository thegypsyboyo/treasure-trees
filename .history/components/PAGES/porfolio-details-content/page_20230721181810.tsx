...
const PortfolioDetailsContent = ({portfolio,allPortfolio}: Props) => {
  ...
  return (
    ...
    {portfolio.singlePortfolioDatas ? (
        ...
        <>
        <div className="flex items-center justify-center">OOPS NO CONTENT YET</div>
        <div className="p-10 px-20 bg-#0b3d2c text-white cursor-pointer pointer">go back</div>
        </>
    )}
    </>
  )
